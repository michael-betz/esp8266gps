...
void GPSDateTime::set_time(String time) { time_ = time.toFloat() * 100; }

uint16_t GPSDateTime::hour() { return time_ / 1000000; }

uint16_t GPSDateTime::minute() { return (time_ / 10000) % 100; }
...
bool GPSDateTime::is_fixed(void) { return isGpsFix; }

String GPSDateTime::getLine() { return serial_line; }
